...
Line 98:2 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 99:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 127:8 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 131:11 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 135:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 142:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 870:6 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 871:8 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 947:11 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 1027:2 Transforming class syntax to the configured target environment ("es5") is not supported yet
